...
public class JsoupDemo2 {
	static String url="http://bbs.10jqka.com.cn/codelist.html";
    /**
     * @param args
     * @throws Exception
     */
...
//        String title = doc2.getElementById("sh").toString(); 
        Elements select = doc2.select("a[href~=http://bbs.10jqka.com.cn/(sh|sz),");
        for(Element s:select){
        	System.out.print(s.attr("href").split(",")[1]);
